...
import operant.dev.helpers.hgit as hgit
"""
...
def does_branch_exist(
    ...
    *,
    ...
    if mode == "github":
        ...
        # no pull requests match your search in the upstream project/sports_analytics
        # ```
        if txt == "":
            return False
...
def _is_repo(repo_short_name: str) -> bool:
    ...
    """
    import operant.dev.helpers.repo_config_utils as hrecouti
...
def git_stash_push(
    ...
    """
    import operant.dev.helpers.hdatetime as hdateti
